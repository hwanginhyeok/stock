...
| 트리거 | 행동 |
|--------|------|
| **작업 착수 시** | 🔥 진행 중에 등록 + 상태 → `진행` + **분야·발행일 지정** |
| **코드 완료, 사용자 액션만 남은 경우** | 진행 중 → ⏸️ 사용자 액션 대기로 이동 |
| **작업 완료 시** | 진행 중/대기에서 삭제 → 완료 섹션 최상단에 추가 (완료일 기록) |
| **새 작업 발견 시** | 즉시 작업 현황에 등록 + 발행일 기록 |
| **커밋 직전** | TASK.md 상태가 실제와 일치하는지 점검 |
| **세션 종료 시** | 미완료 작업 진행 상황 기록, 완료된 건 정리 |
