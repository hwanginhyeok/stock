...
| Tesla Bus | — | ❌ 미완료 |
| FSD (인간 대비 10배 안전) | 2026년 1월 Austin 비감독 운행 시작 — 안전요원 없이 승객 탑승 | 🔄 진행 중 |
| Robotaxi (차량 수익 창출) | 2025년 6월 유인 서비스 → 2026년 1월 무인 전환, 확장 중 | 🔄 확장 중 |

달성률: **50~60%.** 차량 목표는 대부분 달성했다. 그리고 Part Deux의 진짜 목표였던 비감독 자율주행과 Robotaxi가 드디어 현실이 되기 시작했다.
...
그런데 Part 3에서 투자자들이 원했던 것은 이런 거시 경제 분석이 아니었다. 그들이 기다린 건 "$25,000짜리 보급형 테슬라"였다. 머스크는 Investor Day에서 세 종류의 신차 실루엣을 공개했고, 그중 하나가 소형 컴팩트카였다.
...
> 📎 *[이미지: Cybercab 사이드뷰 — Santana Row, 2024 / © dllu, CC-BY-SA 4.0]*

---

## Part 4 (2025): 미션이 바뀌었다

2025년 9월, 머스크는 네 번째 마스터 플랜을 발표한다.
...
방향이 일관된다는 것을 알 수 있다. 각 플랜은 이전 플랜의 달성 위에 세워졌고, 매번 한 단계 더 근본적인 제약을 공략했다.
...
2026년 기준으로 그림이 맞춰지기 시작하고 있다. Cybercab이 Austin에서 무인 운행 중이다. Optimus는 공장 안에서 작업을 배우고 있다. Megapack은 매 분기 성장하고 있다.
...
2018년 SXSW에서 머스크는 한 로켓 과학자를 인용했다. 콘스탄틴 치올콥스키 — 현대 우주공학의 이론적 토대를 세운 사람.

> 📎 *[이미지: 치올콥스키 초상화 — 퍼블릭 도메인]*

*"지구는 인류의 요람이다. 하지만 인류는 요람에 영원히 머물 수 없다."*

머스크는 그 자리에서 말했다.

*"I found that incredibly exciting. That makes me glad to be alive."*

테슬라가 에너지·이동·노동의 제약을 지구에서 풀어가는 동안, Starship은 요람 밖으로 나가는 경로를 만들고 있다. Optimus는 인간보다 먼저 화성에 도착해 인프라를 구축할 것이다.

지구에서 증명된 기술이 다음 행성의 인프라가 되는 것. 멀티플래너터리 인종으로 나아가는 것. 이것이 머스크가 테슬라를 만든 이유의 끝이다.
