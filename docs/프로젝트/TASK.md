...
| 4-11 | 아티클 | KR-03~06: 현대차 시리즈 (4편, 재구성) | 사용자 + AI | 1편 게시 대기, 2편 v2 퇴고 완료 | 2편 시각화 → x_publish → 3편 기획 |
...
| 4-14 | 아티클 | 일론머스크 생태계 상상콘텐츠 | 사용자 + AI | 기획 단계 | 콘셉트·포맷·범위 확정 → 시나리오 → 제작 |
...
**현황 (2026-03-11)**: 1편 게시 대기, 2편 v2 퇴고 완료
...
| 2편 | KR-04 | 빠르게 만드는 것과 다르게 만드는 것 | Tesla 5단계, 삼성/애플, SW-HW 통합 | 016 | **v2 퇴고 완료** |
...
**2편 (016) — KR-04 "빠르게 만드는 것과 다르게 만드는 것"**
- [x] Tesla 5단계 제조 철학 리서치
- [x] 삼성/애플 가치분배 비교
- [x] Physical AI SW-HW 통합 논점
- [x] v1 초안 완료 — `016_KR_현대차-철학비교/drafts/kr-04_hyundai_philosophy_v1.md`
- [x] 퇴고 → v2 완료 (§6 NVIDIA/Google 상세 대폭 축소, §5 수직통합 키워드 추가, §3 Giga Press 수치 소프트닝, §7 제목 추가, 예고편 MobED 제거, 시각적 호흡 16곳, 오타 수정)
- [x] sources.md 전면 재작성 — v2 기준 1차 자료 9건, 데이터 15건, 인용문 3건, 미검증 2건 등재
- [ ] 시각화 (5단계 비교, 삼성/애플 가치분배, 수직통합 스펙트럼)
...
- `data/articles/016_KR_현대차-철학비교/` (2편)
...
| # | 분야 | 작업 | 남은 사용자 액션 |
|---|------|------|-----------------|
| 4-10 | 아티클 | 012 의식을 우주로 확장한다는 것 | v6 퇴고 완료 → **x_publish 변환** → 게시 (3/10 예정) |
