...
| 1-35 | 시스템 | InvestOS 이벤트 체계 대개편 | AI | 요청 (4/6) | **야간작업**: EventType geo/stock 분리, 스토리 체이닝, 과거 백필, 관계도 Top10 필터 + 설명 개선 |
| 1-36 | 시스템 | 관계도 복잡성 해소 — Top10 필터 + 설명 UX 개선 | AI | 요청 (4/6) | **야간작업**: 대안 조사 → 구현 → 브리핑 |
