...
| 4-11 | 아티클 | KR-03~06: 현대차 시리즈 (4편, 재구성) | 사용자 + AI | 1편 게시 대기, **2편 게시 대기** (§5-7 재구성+시각화+이미지 완료) | 1편 X 게시 → 2편 X 게시 → 3편 기획 |
...
|---|------|------|--------|------|--------|------|------|
| 5-8 | 리서치 | 이란 전쟁 지정학 온톨로지 — 나라별 연관관계 + 히스토리 + 지속 추적 | P1 | AI + 사용자 | 2026-03-28 | 진행 | 온톨로지 시스템 활용, 무한 확장형 |
